...
* 핵 유저의 무기 획득 수가 더 낮고, 돕는 비율이 더 적음<br>
...
* 핵 유저(주황), 정상 유저(파랑)의 분포를 봤을 때, 핵 유저는 상위 등수에 포진하고 있지는 않지만, 하위 등수에는 포진하는 경우아 아예 없음<br>

* 정상 유저는 우승했음에도 하위 등수에 있는 경우가 있음 (핵 유저에 비해 실력이 고르게 분포 즉, 운 좋게 우승하는 경우도 빈번히 있음)<br>
...
* 총 파밍만 하기 때문에, 수류탄을 잘 사용하지 않는다. 따라서 동시 처지 횟수가 낮다.<br>

* 소생, 회복 등 돕는 횟수가 적다.<br>

* 핵 유저는 처치횟수 등수가 정상 유저에 비해 더 높은 편에 속한다.<br>

* 정상 유저는 처지 등수가 낮음에도 불구하고 치킨을 먹는 경우가 종종있다. 즉, 존버는 승리한다.<br>
