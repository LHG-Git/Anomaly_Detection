...
# 🔥 목적 및 필요성
* 일반 유저들의 원활한 게임
> - 일반 유저들이 비인가 프로그램 사용 유저들로 인해 많은 피해를 받고 있는 상황
> - 일반 유저들이 게임 유저 이탈을 하지 않도록 대비책 마련 시급
* 비인가 프로그램 사용자 탐지의 필요성
> - 비인가 프로그램 사용자들을 모두 탐지해 제한시킨다면 일반 유저 뿐만 아니라 새로운 유저들도 증가할 것이라 예상 
* 환경관리해역 설정의 필요성
