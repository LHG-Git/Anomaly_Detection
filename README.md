...
# 🔎 가설 설정 및 검증
### 1) 가설 설정
* 가설1 : 핵유저는 정상유저보다 게임 내 아이템 파밍 횟수가 낮을 것이다.<br>
* 가설2 : 게임 내 킬 중 헤드샷 킬의 비율이 비정상적으로 높다면 에임핵을 사용하는 유저일 것이다.<br>
* 가설3 : 핵유저는 정상유저보다 무기 획득 수 대비 boosts+heals와 같은 힐링 아이템의 비율이 더 적을 것이다.<br>

<br><br>

### 2) 가설 검증
* 가설1 : 핵유저는 정상유저보다 게임 내 아이템 파밍 횟수가 낮을 것이다.
* p_value(=0.0061) < a(=0.05)으로 인한 대립가설 채택 → 핵유저와 정상유저의 파밍 빈도에는 유의한 차이가 있다.<br>

<br>

* 가설2 : 게임 내 킬 중 헤드샷 킬의 비율이 비정상적으로 높다면 에임핵을 사용하는 유저일 것이다.
* p_value(≓0.001) < a(=0.05)으로 인한 대립가설 채택 → 핵유저와 정상유저의 헤드샷킬 비율에는 유의한 차이가 있다.<br>

<br>

* 가설3 : 핵유저는 정상유저보다 무기 획득 수 대비 boosts+heals와 같은 힐링 아이템의 비율이 더 적을 것이다.
* p_value(≓0.001) < a(=0.05)으로 인한 대립가설 채택 → 핵유저와 정상유저의 boosts+heals의 아이템 비율에는 유의한 차이가 있다.
