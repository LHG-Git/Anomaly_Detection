...
* 가설3 : 핵유저는 정상유저보다 무기 획득 수 대비 힐링 아이템의 비율이 더 적을 것이다.<br>

<br><br>

### 2) 가설 검증
* 가설1 : 핵유저는 정상유저보다 게임 내 아이템 파밍 횟수가 낮을 것이다.
* Man whitey U test를 통하여 핵유저와 정상유저의 유의 변수를 도출
...
* 가설3 : 핵유저는 정상유저보다 무기 획득 수 대비 힐링 아이템의 비율이 더 적을 것이다.
* Man whitey U test를 통하여 핵유저와 정상유저의 유의 변수를 도출
* p_value(≓0.001) < a(=0.05)으로 인한 대립가설 채택 → 핵유저와 정상유저의 힐링 아이템 비율에는 유의한 차이가 있다.
