...
# 🧾 가설 검증
### 1) 가설 1, 가설 2
* <strong>핵 유저의 aim_point 값이 대부분 1에 수렴한다.
* 가설대로 핵 유저의 헤드샷 비율이 정상 유저보다 확연히 더 높은것을 확인하였다.</strong><br>
* 따라서, 핵 유저는 비인가 프로그램인 에임핵을 사용하여 aim_point가 높은 유저이다.
<br>

### 2) 가설 3
* <strong>무기획득에 대한 평균 검정을 한 결과 p값이 0.05보다 작아 통계적으로 유의한 차이가 있다.</strong><br>
* <strong>가설대로 핵 유저의 무기획득의 평균 수가 적음을 확인하였다.</strong><br>
* <strong>따라서, 핵 유저는 파밍을 많이 하지 않는다.</strong><br>
<br>

### 3) 가설 4
* <strong>도움 행위 수에 대한 평균 검정을 한 결과 p값이 0.05보다 작아 통계적으로 유의한 차이가 있다.</strong><br>
* <strong>가설대로 핵 유저의 무기 획득 수 대비 boosts+heals의 아이템 비율이 적음을 확인하였다.</strong><br>
* <strong>따라서, 핵 유저는 도움 행위을 많이 하지 않는다.</strong><br>
